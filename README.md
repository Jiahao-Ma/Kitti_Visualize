...
2. 2D and 3D boxes on in image2 coordinate. Implemented by `draw_2DBBox_in_rgb()` and `draw_3DBBox_in_rgb()`. See [2D_result](https://github.com/Robert-Mar/Kitti_Visualize/tree/main/git_image/git_image/draw_3DBBox_in_rgb.png) and [3D_result](https://github.com/Robert-Mar/Kitti_Visualize/tree/main/git_image/git_image/draw_2DBBox_in_rgb.png). 
3. Point clouds visualize in velodyne coordinate. Implemented by `draw_pointclouds_in_velo()`. [See result](https://github.com/Robert-Mar/Kitti_Visualize/tree/main/git_image/git_image/draw_pointclouds_in_velo.png)
4. LiDar data on Camera image. Implmented by `draw_pointclouds_in_rgb()`. [See result](https://github.com/Robert-Mar/Kitti_Visualize/tree/main/git_image/git_image/draw_pointclouds_in_rgb.png).
